...
<head>
	...
	<script type="text/javascript" src="${ctx}assets/js/view/order/pay/detail.js"></script>
</head>
<body>
	<!-- Content area -->
	<div class="content">
				...
				<table class="table table-hover table-bordered">
				    ...
				    <tbody>
                       ...
                       <tr>
                           ...
                           <td class="text-agl" width="25%"><fmt:formatDate value="${data.orderTime}" pattern="yyyy-MM-dd"/></td>
                           <td class="text-agr" width="25%" align="right">支付完成时间：</td>
                           <td class="text-agl" width="25%"><fmt:formatDate value="${data.finishTime}" pattern="yyyy-MM-dd"/></td>
                       </tr>
                       <tr>
