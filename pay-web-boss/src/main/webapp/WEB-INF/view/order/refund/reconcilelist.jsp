...
<head>
	...
	<script type="text/javascript" src="${ctx}assets/js/view/order/refund/reconcilelist.js"></script>
		...
		<div class="page-header-content">
			<div class="page-title">
				<h4>
					...
					<span id="nav-second-menu">退款订单管理</span>
				</h4>
			</div>
		</div>
	...
	<div class="content">
		...
		<div class="panel panel-flat">
			<div class="panel-heading">
				<h5 class="panel-title">退款订单列表</h5>
					...
					<div id="searchDiv" class="well well-sm" style="margin-bottom:10px;">
						<div class="form-group">
							<select name="searchKey" class="form-control">
							  <option value="refund_no">枫车退款流水号</option>
							  <option value="trade_no">第三方退款流水号</option>
							  <option value="merchant_order_no">商户退款订单号</option>
							  <option value="buyer_id">第三方支付退款人ID</option>
...
<script id="tabledata" type="text/html">
	...
	{{# for(var i = 0, len = d.data.length; i < len; i++){ }}
		<tr>
		    ...
		    <td>
				{{# if(d.data[i].refundStatus=='application'){ }}
					退款申请中
				{{# }else if(d.data[i].refundStatus=='success'){ }}
					退款成功
				{{# }else if(d.data[i].refundStatus=='faile'){ }}
					退款失败
				{{# } }}
				<br/>对账批次号暂无
			</td>
		    ...
		    <td>
				 <s:hasPermission name="order:refund:view">
