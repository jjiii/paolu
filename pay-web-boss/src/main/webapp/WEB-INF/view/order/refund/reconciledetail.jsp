...
<head>
	...
	<script type="text/javascript" src="${ctx}assets/js/view/order/refund/reconciledetail.js"></script>
</head>
<body>
	<!-- Content area -->
	<div class="content">
				...
				<table class="table table-hover table-bordered">
				    ...
				    <tbody>
				     	<tr>
                           ...
                           <td class="text-agl" width="25%">${refundOrder.refundNo}</td>
                       ...
                       <tr>
                           ...
                           <td class="text-agl" width="25%">￥&nbsp;&nbsp;${refundOrder.refundAmount}</td>
