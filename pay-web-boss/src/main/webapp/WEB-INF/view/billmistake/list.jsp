...
<head>
	...
	<script src="${ctx}assets/js/view/billmistake/list.js"></script>
</head>
		...
		<div class="page-header-content">
			<div class="page-title">
				<h4>
					...
					<span id="nav-second-menu">对账差错管理</span>
				</h4>
			</div>
		</div>
	...
	<div class="content">
		...
		<div class="panel panel-flat">
			<div class="panel-heading">
				<h5 class="panel-title">对账差错列表</h5>
...
<script id="tabledata" type="text/html">
	...
	{{# for(var i = 0, len = d.data.length; i < len; i++){ }}
		<tr>
		    ...
		    <td>
				<button type="button" class="btn btn-default btn-xs" href="javascript:;" onclick="detail('{{=d.data[i].payOrderNo||d.data[i].refundOrderNo}}')">
