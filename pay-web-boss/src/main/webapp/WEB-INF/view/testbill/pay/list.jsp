...
<head>
	...
	<script type="text/javascript" src="${ctx}assets/js/view/testbill/pay/list.js"></script>
		...
		<div class="page-header-content">
			<div class="page-title">
				<h4>
					...
					<span id="nav-second-menu">修改支付订单</span>
				</h4>
			</div>
		</div>
...
<script id="tabledata" type="text/html">
	...
	{{# for(var i = 0, len = d.data.length; i < len; i++){ }}
		<tr>
		    ...
		    <td>
				<s:hasPermission name="test:payorder:edit">
				{{# if(d.data[i].billStatus=='wait'){ }}
