...
<head>
	...
	<script type="text/javascript" src="${ctx}assets/js/view/testbill/refund/list.js"></script>
		...
		<div class="page-header-content">
			<div class="page-title">
				<h4>
					...
					<span id="nav-second-menu">修改退款信息</span>
				</h4>
			</div>
		</div>
					...
					<div id="searchDiv" class="well well-sm" style="margin-bottom:10px;">
						<div class="form-group">
							<select name="searchKey" class="form-control">
							  <option value="order_no">枫车退款流水号</option>
...
<script id="tabledata" type="text/html">
	...
	{{# for(var i = 0, len = d.data.length; i < len; i++){ }}
		<tr>
		    ...
		    <td>
				 <s:hasPermission name="test:refundorder:edit">
				 {{# if(d.data[i].billStatus=='wait'){ }}
