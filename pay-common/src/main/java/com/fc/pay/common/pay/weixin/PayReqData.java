...
public class PayReqData {
    ...
    private String openid = ""; //"013kYFko0eGaKo1k4Kgo0SXyko0kYFkw";
...
//     * @param deviceInfo 商户自己定义的扫码支付终端设备号，方便追溯这笔交易发生在哪台终端设备上
     ...
     */
    public PayReqData(String authCode,String body,String attach,String outTradeNo, int totalFee,
//    		String deviceInfo,
    		String spBillCreateIP,String timeStart,String timeExpire,String goodsTag,String notify_url, String openid){
