...
public class RSA {  
     ...
     * @throws Exception  
     */  
    public static String decryptByPrivateKey(String encryptedSrc, String privateKey){
    	try{
    		byte[] encryptedData = Base64.decodeBase64(encryptedSrc);
	        byte[] keyBytes = Base64.decodeBase64(privateKey);
	        PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(keyBytes);  
	        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);  
     ...
     * @throws Exception  
     */  
    public static String decryptByPublicKey(String encryptedSrc, String publicKey){
    	try{
    		byte[] encryptedData = Base64.decodeBase64(encryptedSrc);
	        byte[] keyBytes = Base64.decodeBase64(publicKey);
